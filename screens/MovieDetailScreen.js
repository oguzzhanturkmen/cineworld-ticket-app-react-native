        ...
        <View className="w-full">
          ...
          <View className=" flex-row justify-center mx-4 space-x-3 mt-2 mb-4">
            {movie?.genres?.map((item, index) => {
              return (
                ...
                >
                  <Text className="text-neutral-50 font-semibold text-center text-xs ">
                    {item.name}
                  </Text>
                </View>
              );
          ...
          <View className="flex-row justify-between ">
            <View className="flex-col justify-between ">
              <Text className="text-white font-bold text-sm mx-3 ">
                {" "}
                Release Date :{" "}
          ...
          <View className="flex-col mt-2">
            ...
            <Text
              className="text-white mx-4 font-semibold tracking-wide my-2 text-sm"
              style={{ lineHeight: 20 }}
            >
              {movie?.overview}
            </Text>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate("Checkout", { movie, item })}
          >
