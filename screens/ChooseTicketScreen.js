  ...
  return (
    <View className = "flex-1 bg-neutral-900 h-full ">
        ...
        <View className = "flex-col  mt-4 justify-between mx-2" >
            ...
            <TouchableOpacity className="flex-row justify-center  mx-4  mb-2 p-3" style={{backgroundColor :  '#96a723', borderRadius : 30 , padding : 7, marginTop : height * 0.10 }} onPress={() => navigation.navigate("Seat", {item, adultNumber, studentNumber, childNumber, total, totalSeats, movie, theater ,time})}>
