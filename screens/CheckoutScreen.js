    ...
    <View className="flex-1 bg-neutral-900 h-full ">
      <SafeAreaView className="mb-2 z-10">
        ...
        >
          <View>
            ...
            <View className="flex-col  mx-3 ">
              ...
              <Text className="text-neutral-300 text-xs ">
                You must choose the movie you want to watch, the theater and the
                session. After that, you can select a ticket.
              </Text>
            </View>
            <View className="flex-col  mx-2 mt-4 justify-between">
              <View
                className="flex-row items-center shadow-lg  shadow-neutral-900"
                style={{
                  backgroundColor: "#393939",
                  borderRadius: 20,
                  height: height * 0.06,
            ...
            {theater ? (
              <View className="flex-col  mx-2 mt-4 justify-between">
                ...
                <View
                  className="flex-col items-start  -mt-8"
                  style={{
                    height: height * 0.1,
                ...
                >
                  <Text className="text-white text-xl font-bold ml-4 mt-10">
                    {theater?.name}
                  </Text>
                  <Text className="text-white text-xs font-bold  ml-4">
                    {theater?.location}
                  </Text>
                </View>
              </View>
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  navigation.navigate("ChooseTheater", { item, movie })
                }
              >
                <View className="flex-row items-center  mx-5 justify-between ">
          ...
          {time ? (
            <TouchableOpacity
              className="flex-row justify-center  mx-4 mt-4 mb-2 p-3"
              style={{
              ...
              onPress={() =>
                navigation.navigate("ChooseTicket", {
                  item,
                  time,
                  hours,
                  minutes,
