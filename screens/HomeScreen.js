  ...
  return (
    <View className="flex-1 bg-neutral-900  ">
      <SafeAreaView className=" z-10">
        ...
        <View className="flex-row justify-between items-center mx-4">
          ...
          <Text className="text-white text-3xl font-bold ">
            cine <Text style={generalStyles.text}>world </Text>
          </Text>
          <TouchableOpacity>
      ...
      <ScrollView className="flex-1">
        ...
        <Text className="text-white text-3xl font-bold mx-4 pb-4">
          Upcoming
        </Text>
            ...
            {upcoming &&
              ...
              upcoming.results.map((item) => {
                return (
                  <View
                    className="flex-row "
                    style={{ width: width * 0.5, borderRadius: 100 }}
                  >
                    <TouchableOpacity
                      onPress={() =>
          ...
          {popular &&
            ...
            popular.results.map((item) => {
              return (
                <View
                  className="flex-row "
                  style={{ width: 0.5 * width, borderRadius: 100 }}
                >
                  <TouchableOpacity
