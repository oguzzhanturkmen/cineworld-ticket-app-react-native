    ...
    <View style={styles.container}>
      ...
      >
        ...
        <ImageBackground
          ...
          style={[styles.cardFront, styles.card]}
        >
          <View className="flex-row justify-between items-center px-10 py-4">
            <View className="flex-col">
              ...
              <Text style={styles.cardText} className="my-2">
                {cardInfo.number}
              </Text>
              <Text className="-my-1 text-xs text-neutral-300 ">Full Name</Text>
              <Text style={styles.cardText} className="mt-1">
                {cardInfo.name}
              </Text>
            </View>
            <View className="flex-col items-end ">
              <Text className=" text-xs text-neutral-300  ">Expires End</Text>
              <Text className="pl-16" style={styles.cardText}>
                {cardInfo.expiry}
              </Text>
            </View>
          </View>
